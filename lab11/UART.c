...
// as part of Lab 11 implement this function
	int i;
	if (n > 9999) { // numbers greater than 9999
			for (i = 0; i < 4; i++) {
					String[i] = '*';
			}
	} else { // convert number to characters
			for (i = 3; i >= 0; i--) {
					String[i] = (n > 0 || i == 3) ? (n % 10 + '0') : ' ';
					n /= 10;
			}
	}
	String[4] = ' '; // space after the digits
	for (i = 5; i < 10; i++) { // clear the rest of the string
			String[i] = '\0';
	}
...
// as part of Lab 11 implement this function
	...
	if (n > 9999) {
        // numbers greater than 9999 as "*.*** cm"
        String[0] = '*';
        for (i = 1; i < 5; i++) {
            String[i] = '*';
        }
        ...
        // Build the string for numbers <= 9999
        String[0] = (n / 1000) + '0';          // Thousands place - 1234 / 100 + '0' = 1
        String[1] = '.';                       // Decimal point 1.
        String[2] = ((n / 100) % 10) + '0';    // Hundreds place n = 1234, n / 100 = 12, (12 % 10) = 2
        String[3] = ((n / 10) % 10) + '0';     // Tens place
        String[4] = (n % 10) + '0';            // Ones place
    }
    // Append " cm"
    String[5] = ' ';
    String[6] = 'c';
    String[7] = 'm';
    String[8] = '\0'; // Null-terminate the string
